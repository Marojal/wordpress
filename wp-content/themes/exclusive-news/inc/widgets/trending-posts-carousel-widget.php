	...
	class Elite_News_Trending_Posts_Carousel_Widget extends WP_Widget {
		...
		public function __construct() {
			$elite_news_trending_carousel_widget_ops = array(
				...
				'description' => __( 'Retrive Trending Posts Carousel Widgets', 'exclusive-news' ),
			);
			parent::__construct(
				'elite_news_magazine_trending_carousel_widget',
				__( 'Ascendoor Trending Posts Carousel Widget', 'exclusive-news' ),
		...
		public function widget( $args, $instance ) {
			...
			<div class="magazine-section-body">
				<div class="magazine-trending-carousel-section-wrapper style-2">
					<?php
		...
		public function form( $instance ) {
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'button_label' ) ); ?>"><?php esc_html_e( 'View All Button:', 'exclusive-news' ); ?></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'button_link' ) ); ?>"><?php esc_html_e( 'View All Button URL:', 'exclusive-news' ); ?></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'offset' ) ); ?>"><?php esc_html_e( 'Number of posts to displace or pass over:', 'exclusive-news' ); ?></label>
			...
			<p>
				<label for="<?php echo esc_attr( $this->get_field_id( 'category' ) ); ?>"><?php esc_html_e( 'Select the category to show posts:', 'exclusive-news' ); ?></label>
