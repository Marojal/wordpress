...
function elite_news_render_banner_section( $banner_grid_args, $editor_picks_args ) {
	...
	<section id="elite_news_banner_section" class="banner-section style-2">
		<?php
		...
		<div class="ascendoor-wrapper">
			<div class="banner-section-wrapper">
						...
						while ( $banner_query->have_posts() ) :
							...
							<div class="mag-post-single has-image <?php echo esc_attr( $i === 1 ? 'list-design' : '' ); ?>">
								...
								<div class="mag-post-detail">
									<div class="mag-post-category <?php echo esc_attr( $i === 1 ? 'with-background' : '' ); ?>">
										<?php elite_news_categories_list( $i === 1 ? true : false ); ?>
									</div>
				...
				<?php $editor_picks_title = get_theme_mod( 'elite_news_editor_picks_title', __( 'Editor\'s Picks', 'exclusive-news' ) ); ?>
				<div class="editor-advedr">
					...
					$two_adver      = ! empty( $advertisement1 && $advertisement2 ) ? 'two-adver' : '';
					?>
					<div class="banner-adver <?php echo esc_attr( $two_adver ); ?>">
						<?php
						for ( $i = 1; $i <= 2; $i++ ) {
							...
							if ( ! empty( $banner_ads ) ) {
								...
								<a href="<?php echo esc_url( $banner_ads_url ); ?>">
									<img src="<?php echo esc_url( $banner_ads ); ?>" alt="<?php esc_attr_e( 'Advertisement Image', 'exclusive-news' ); ?>">
								</a>
								<?php
							}
						}
