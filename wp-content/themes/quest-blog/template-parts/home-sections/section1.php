...
$quest_blog_section_one = get_theme_mod( 'quest_blog_section1_enable' );
if ( 'Disable' == $quest_blog_section_one ) {
  return;
} ?>
  ...
  <div class="main-section-content">
    <div class="row">
      <?php
        ...
        $args = array(
          'category_name' =>  get_theme_mod('quest_blog_section1_category'),
          'posts_per_page' => 6,
          'order' => 'DESC'
        );
