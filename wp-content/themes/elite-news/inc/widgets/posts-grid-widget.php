<?php
if ( ! class_exists( 'Elite_News_Posts_Grid_Widget' ) ) {
	/**
	 * Adds Elite_News_Posts_Grid_Widget Widget.
	 */
	class Elite_News_Posts_Grid_Widget extends WP_Widget {
		...
		public function __construct() {
			$elite_news_grid_widget_ops = array(
				'classname'   => 'ascendoor-widget magazine-grid-section style-1',
				'description' => __( 'Retrive Posts Grid Widgets', 'elite-news' ),
			);
			parent::__construct(
				'elite_news_magazine_grid_widget',
				__( 'Ascendoor Posts Grid Widget', 'elite-news' ),
				$elite_news_grid_widget_ops
			);
		}
