<?php
if ( ! class_exists( 'Elite_News_Posts_List_Widget' ) ) {
	/**
	 * Adds Elite_News_Posts_List_Widget Widget.
	 */
	class Elite_News_Posts_List_Widget extends WP_Widget {
		...
		public function __construct() {
			$elite_news_list_widget_ops = array(
				'classname'   => 'ascendoor-widget magazine-list-section style-1',
				'description' => __( 'Retrive Posts List Widgets', 'elite-news' ),
			);
			parent::__construct(
				'elite_news_magazine_list_widget',
				__( 'Ascendoor Posts List Widget', 'elite-news' ),
				$elite_news_list_widget_ops
			);
		}
