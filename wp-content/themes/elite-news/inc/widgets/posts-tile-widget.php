<?php
if ( ! class_exists( 'Elite_News_Posts_Tile_Widget' ) ) {
	/**
	 * Adds Elite_News_Posts_Tile_Widget Widget.
	 */
	class Elite_News_Posts_Tile_Widget extends WP_Widget {

		/**
		 * Register widget with WordPress.
		 */
		public function __construct() {
			$elite_news_tile_widget_ops = array(
				'classname'   => 'ascendoor-widget magazine-tile-section style-2',
				'description' => __( 'Retrive Posts Tile Widgets', 'elite-news' ),
			);
			parent::__construct(
				'elite_news_magazine_tile_widget',
				__( 'Ascendoor Posts Tile Widget', 'elite-news' ),
				$elite_news_tile_widget_ops
			);
		}
