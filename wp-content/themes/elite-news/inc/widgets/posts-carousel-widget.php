<?php
if ( ! class_exists( 'Elite_News_Posts_Carousel_Widget' ) ) {
	/**
	 * Adds Elite_News_Posts_Carousel_Widget Widget.
	 */
	class Elite_News_Posts_Carousel_Widget extends WP_Widget {

		/**
		 * Register widget with WordPress.
		 */
		public function __construct() {
			$elite_news_post_carousel_widget_ops = array(
				'classname'   => 'ascendoor-widget magazine-post-carousel-section',
				'description' => __( 'Retrive Posts Carousel Widgets', 'elite-news' ),
			);
			parent::__construct(
				'elite_news_posts_carousel_widget',
				__( 'Ascendoor Posts Carousel Widget', 'elite-news' ),
				$elite_news_post_carousel_widget_ops
			);
		}
