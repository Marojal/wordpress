 ...
 * Register Widgets
 */
function elite_news_register_widgets() {

	register_widget( 'Elite_News_Posts_Grid_Widget' );

	register_widget( 'Elite_News_Posts_List_Widget' );

	register_widget( 'Elite_News_Categories_Widget' );

	register_widget( 'Elite_News_Posts_Small_List_Widget' );

	register_widget( 'Elite_News_Posts_Tile_Widget' );

	register_widget( 'Elite_News_Posts_Grid_And_List_Widget' );

	register_widget( 'Elite_News_Posts_Carousel_Widget' );

	register_widget( 'Elite_News_Trending_Posts_Carousel_Widget' );

	register_widget( 'Elite_News_Social_Icons_Widget' );
	
}
add_action( 'widgets_init', 'elite_news_register_widgets' );
