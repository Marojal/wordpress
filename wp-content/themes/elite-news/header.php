...
<body <?php body_class(); ?>>
	...
	<div id="page" class="site">
		<a class="skip-link screen-reader-text" href="#primary"><?php esc_html_e( 'Skip to content', 'elite-news' ); ?></a>
		<div id="loader">
					...
					<div class="middle-header-wrapper <?php echo esc_attr( ! empty( get_header_image() ) ? 'ascendoor-header-image' : '' ); ?>">
						<?php if (!empty(get_header_image())) : ?>
							<div class="bgheader-image">
								<img class="ascendoor-header-bgimage" src="<?php echo esc_url(get_header_image()); ?>" alt="<?php esc_attr_e('Header Image', 'elite-news'); ?>">
							</div>
						<?php endif; ?>
					...
					if ( ! empty( $advertisement ) ) {
						...
						<div class="mag-adver-part">
							<a href="<?php echo esc_url( $advertisement_url ); ?>">
								<img src="<?php echo esc_url( $advertisement ); ?>" alt="<?php esc_attr_e( 'Advertisment Image', 'elite-news' ); ?>">
							</a>
						</div>
						<?php
					}
